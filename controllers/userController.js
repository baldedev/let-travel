...
exports.signUpPost = [
  ...
  check("first_name")
    ...
    .isAlphanumeric()
    .withMessage("First name must be isAlphanumeric"),

  check("surname")
    .isLength({ min: 1 })
    .withMessage("Surname must be specified")
    .isAlphanumeric()
    .withMessage("Surname must be isAlphanumeric"),
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      ...
      User.register(newUser, req.body.password, function(err) {
        ...
        next(); //move on to loginPost after registering
      });
    }
  }
];
  ...
  try {
    ...
    const order = new Order({
      ...
      order_details: {
        ...
        dateOfDeparture: parsedData.dateOfDepature,
