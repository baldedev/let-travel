...
//   res.render("index", { title: "Let's travel to chicago" });
// };
...
exports.editRemovePost = async (req, res, next) => {
  try {
    ...
    if (hotelData.length > 0) {
      ...
      req.flash("info", "No mathes were found ....");
...
exports.searchResults = async (req, res, next) => {
  try {
    ...
    const parsedStars = parseInt(searchQuery.stars) || 1; //ici "1" pour selectionner par ordre croissant layout.pug (select/option)
